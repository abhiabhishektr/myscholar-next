...
export default function MyClassesContent() {
  ...
  const filterClasses = () => {
    ...
    if (studentNameFilter) {
      filtered = filtered.filter((cls) =>
        cls.studentName.toLowerCase().includes(studentNameFilter.toLowerCase())
      );
    }
  ...
  const calculateStats = () => {
    ...
    const uniqueStudents = new Set(filteredClasses.map((cls) => cls.studentId)).size;
    ...
    <div className="flex-1 overflow-auto">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter classes by date range and student</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                    <div className="space-y-2 flex-1">
                      ...
                      <p className="text-xs text-gray-400">
                        Marked: {new Date(cls.markedAt).toLocaleString()}
                      </p>
                    </div>
                  </div>
                </CardContent>
