...
export default function StudentClassesContent() {
  ...
  const calculateStats = () => {
    ...
    const uniqueSubjects = new Set(filteredClasses.map((cls) => cls.subjectId)).size;

    return { totalClasses, totalHours, uniqueSubjects };
  };
    ...
    <div className="flex-1 overflow-auto">
      <div className="container mx-auto px-4 py-8 max-w-7xl space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">View your learning history</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Filter classes by date range</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold">
            Class History ({filteredClasses.length} {filteredClasses.length === 1 ? "class" : "classes"})
          </h2>
                  ...
                  <CardContent className="pt-6">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      <div className="space-y-2 flex-1">
                        ...
                        <div>
                          <h3 className="font-semibold text-lg">{cls.subjectName}</h3>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Completed: {new Date(cls.markedAt).toLocaleString()}
                        </p>
                      </div>
                    </div>
                  </CardContent>
